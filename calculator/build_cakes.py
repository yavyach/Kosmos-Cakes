...
CAKES = [
    # ============ ТИП 1 — ЯРУСНЫЕ ============
    {
        ...
        "title":"белль",
        "desc":"Многообразие форм, цветов, размеров и узоров. Вкупе с лентами и вишенками - полная тортовая феерия! Каждый ярус/торт может быть с разной начинкой, а какие-то из них могут быть фальш ярусами.\nМожет быть как разноцветным, так и монохромным.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
        "details":"Торт назван в честь принцессы из мультфильма \"Красавица и чудовище\" компании Дисней.",
        "decorPerTier":3000, "minWeight":6, "minTiers":6, "fillings":"BASE"
    },
    {
        "id":"lumiere", "type":"tiered", "name":"люмьер",
        "title":"люмьер",
        "desc":"Ещё более смелый и фееричный вариант торта Белль. Каждый ярус/торт может быть с разной начинкой, а какие-то из них могут быть фальш ярусами.\nМожет быть как разноцветным, так и монохромным.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
        "details":"Торт назван в честь заколдованного персонажа мультфильма \"Красавица и чудовище\" компании Дисней.",
        "decorPerTier":3000, "minWeight":10, "minTiers":10, "fillings":"PLUS_CHEESECAKE"
    },
    {
        "id":"fairy-cake", "type":"tiered", "name":"fairy cake",
        "title":"fairy cake",
        "desc":"По-настоящему сказочный большой торт, как из мультика. Мечта детства!\nДля сохранения сказочного объёма торта при небольшом весе, возможно использование фальш ярусов.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
    ...
    },
    {
        ...
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию. Для сохранения объёма торта при небольшом весе, возможно использование фальш ярусов.",
        "decorPerTier":3000, "minWeight":6, "minTiers":2, "fillings":"BASE"
    },
    {
        "id":"kuinji", "type":"tiered", "name":"куинджи",
        "title":"куинджи",
        "desc":"Красота живой природы, перенесенная на торт. Узоры, цветы, листья, орнаменты и многое другое смогут гармонично дополнить задумку вашего мероприятия. Да и сам по отдельности выглядит эстетично и утонченно.\nРоспись может быть разной сложности, от этого рассчитывается и цена.",
        "subtitle":"Цвет, рисунок и другие детали могут меняться по вашему желанию.",
        "details":"Торт назван в честь выдающегося русского художника-пейзажиста.",
    ...
    },
    {
        ...
        "title":"дарси",
        "desc":"Монохром, крем - и всё! Базовый, но в то же время породистый торт. Классическая классика. Более сдержанный и минималистичный в сравнении с \"Элизабет\".\nМожет быть как небольшим аккуратным полутора килограммовым тортиком, так и огромным шестиярусным исполином. В любом размере не теряет свою эстетику и величавость.",
	"subtitle":"Цвет и другие детали могут меняться по вашему желанию. Для сохранения объёма торта при небольшом весе, возможно использование фальш ярусов.",
	"details":"Торт назван в честь одного из главных героев романа Джейн Остин \"Гордость и предубеждение\".",
        "decorPerTier":3000, "minWeight":1.5, "minTiers":1, "fillings":"BASE"
    },
    {
        "id":"shine-bright", "type":"tiered", "name":"shine bright",
        "title":"shine bright",
        "desc":"Торт для тех, кто хочет сиять! Покрытие может быть серебряным, золотым или перламутровым. Наносится тончайшим слоем из аэрографа.\nЛучше всего сочетается с красными элементами, например ягодами, но может смотреться хорошо и без дополнений.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Название торта вдохновлено строчкой из песни Рианны Diamonds.",
        "decorPerTier":3500, "minWeight":1.5, "minTiers":1, "fillings":"BASE"
    },
    {
        "id":"kelly", "type":"tiered", "name":"келли",
        "title":"келли",
        "desc":"Ярусный торт может быть плоским и выглядеть эстетично и аккуратно!\nУтонченный декор и игра с цветом.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь иконы Голливуда Грейс Келли.",
        "decorPerTier":2000, "minWeight":4, "minTiers":1, "fillings":"TYPE3_LOVE"
    },
    {
        ...
        "subtitle": "Цвет и другие детали могут меняться по вашему желанию. Для сохранения объёма торта при небольшом весе, возможно использование фальш ярусов.",
	    "details":"Торт назван в честь главной героини романа Джейн Остин \"Гордость и предубеждение\".",
        "decorPerTier":3000, "minWeight":1.5, "minTiers":1, "fillings":"BASE"
    },
    # ============ ТИП 2 — ФИКС. ВЕС ============
    {
        ...
        "title":"фаберже",
        "desc":"По-императорски величественный и роскошный торт с вензелями, рюшами и лепниной. Эпизодически может дополняться вишенками, ленточками или свежими ягодами.",
        "subtitle":"Вес фиксированный - 2,5 или 3,5 кг.\nЦвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь знаменитых ювелирных изделий, создававшихся преимущественно для Российского Императорского Дома и ставших символом роскоши и богатства.",
        "decor":{"2.5":3000, "3.5":3500}, "fillings":"BASE"
    },
    {
        "id":"secret-garden", "type":"fixed", "name":"secret garden",
        "title":"secret garden",
        "desc":"Минималистично, необычно, аутентично.\nЦветы могут быть любые, главное - единая композиция!",
        "subtitle":"Вес фиксированный - 2,5 или 3,5 кг.\nЦвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь романа Фрэнсис Бёрнетт о надежде и исцелении.",
    ...
    },
    {
        ...
        "subtitle":"Вес фиксированный - 2,5 или 3,5 кг.\nЯгоды и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь классического хита Фэтса Домино.",
    ...
    },
    {
        ...
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь оскароносного мюзикла о несбывшейся любви.",
        "decor":{"2.5":3000, "3.5":3500}, "fillings":"BASE"
    },
    ...
    # ============ ТИП 3 — ПЛОСКИЙ ПО ВЕСУ ============
    {
        ...
        "desc":"Кремовые рюши, роскошный декор и элегантные сахарные фрукты. Настоящее тортовое барокко!\nВозможны варианты с разным расположением, количеством и разнообразием фруктов, в том числе и моно, как на примере с яблочками.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь вечного хита группы Queen.",
    ...
    },
    {
        ...
        "title":"вавилон",
        "desc":"Высокий, грациозный, впечатляющий торт. Возможен только легкий кремовый декор или банты. Производит нужное впечатление преимущественно в большом размере (от 80 см). Если веса не хватает для создания высоты, возможно частичное использование фальш ярусов.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Название торта вдохновлено древним мифом о попытке людей построить высочайшую башню и добраться до небес.",
    ...
    },
    {
        ...
        "desc":"Утонченный и глубокий, как русское искусство 19 века. Кремовые цветы, миндальные лепестки, можно добавить лебедей из безе.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь покорившего весь мир балета Петра Ильича Чайковского.",
    ...
    },
    {
        ...
        "title":"green day",
        "desc":"Азиатский стиль вписанный в современный праздничный торт. Виноград сорта шайн мускат отлично дополняет почти любую начинку внутри.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь культовой американской панк-рок группы.",
    ...
    },
    {
        ...
        "subtitle":"Рекомендуется к заказу в большом размере (от 4-5 кг) и в летний сезон черешни. Ягоду и цвет менять не рекомендуется, но возможны разные варианты.\nЦвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь пьесы Антона Павловича Чехова об уходящей эпохе и неизбежности перемен.",
    ...
    },
    {
        ...
        "desc":"Любовь - лучшее, что случалось с этим миром! Поэтому и сердце должно быть большим.\nКлассический вариант для любой свадьбы.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь культовой мелодрамы Вонга Карвая.",
    ...
    },
    {
        ...
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь главной героини трагического романа Льва Николаевича Толстого \"Анна Каренина\".",
    ...
    },
    {
        ...
        "title":"ягодные поля",
        "desc":"Свежая сочная ягода - чем не идеальное дополнение к торту? Особенно когда её ТАК много! Лучше выбирать сезонную ягоду, чтобы она была и красивая, и вкусная.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Название торта вдохновлено знаковой песней группы the Beatles, разделившей творчество квартета на до и после.",
        "decorTable":[
    ...
    },
    {
        ...
        "title":"вам письмо",
        "desc":"Послание во вселенную прямо на торте! Лучше лаконично и емко.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь культового ромкома 90-х.",
    ...
    },
    {
        ...
        "title":"орфей",
        "desc":"Классического вида, но необычный своей вытянутостью торт. В отличие от “аполлона”, может быть только длинным, низким и/или узким, что делает его менее классическим, но более заметным акцентом праздника. Также нарезка или поедание такого торта может стать целым иммерсивным событием.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь божественного музыканта, героя древнегреческой мифологии, сына Аполлона.",
    ...
    },
    {
        ...
        "title":"аполлон",
        "desc":"Величественный и изящный прямоугольный торт. В отличие от \"орфея\" более широкий и классический, может иметь большую высоту и/или несколько ярусов.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь древнегреческого бога света, покровителя муз и искусств, отца Орфея.",
    ...
    },
    {
        ...
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь культового аниме-сериала.",
        "decorTable":[(1.5,3,3000),(4,5,3500),(6,7,5500)],
    ...
    },
    {
        ...
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь великого поп-хита группы ABBA.",
        "decorTable":[(2,4.5,4000),(5,20,6500)],
        "minWeight":2, "maxWeight":20, "fillings":"BASE",
        "note":"Декор выполнен из шоколадного крема."
    },
    {
        "id":"totoro", "type":"weight", "name":"тоторо",
        "title":"тоторо",
        "desc":"Торт не всегда должен быть эффектным или эстетичным, иногда он может быть просто милым или забавным.\nМы не возьмемся делать конкретных персонажей из-за авторских прав, но с удовольствием изобразим вашего любимого питомца, просто смешного и милого зверька или целую компанию.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь героя анимационного фильма Хаяо Миядзаки о дружбе и доброте.",
   ...
   
    {
        ...
        "title":"fuji",
        "desc":"Объемная шапка из крема, цветные полоски, бантики, ягоды. Азиатский стиль!\nМожет быть как небольшим одноярусным, так и двухъярусным. От трех ярусов и выше - теряет свою задумку.",
        "subtitle":"Цвет и другие детали могут меняться по вашему желанию.",
	"details":"Торт назван в честь главного символа Японии.",
    ...
    },
    {
        ...
        "title":"тирамису",
        "desc":"Mama mia, dolce vita, bellissimo!\nНастоящий итальянский тирамису. Может быть круглым или длинным. Эффектно смотрится в большой ширине.",
        "subtitle":"Стандартная надпись дешевле, индивидуальная - дороже.",
        "decorTable":[(1,10,0)],
...
from typography import normalize_cake_fields

for _cake in CAKES:
    normalize_cake_fields(_cake)
